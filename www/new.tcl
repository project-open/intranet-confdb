...
set project_options [util_memoize [list im_project_options -include_empty 1 -project_status_id [im_project_status_open]] 3600]
set owner_options [util_memoize [list im_user_options]]
